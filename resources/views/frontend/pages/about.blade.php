                        ...
                        <div class="ui-icon ui-icon-lg inner">
                            <div class="ui-icon-inner ui-icon-inner-lg">
                                <a href="javascript:;" style="font-size:28px; cursor: default;"><img
                                        src="{{ asset($service->image_link) }}"
                                        style="cursor: default; width:35px;" /></a>
                            </div>
                        </div>
                    </div>
                    ...
                    @foreach ($about->experiences as $experience)
                        <div class="timeline-content">
                            <div class="mb-1">
                                ...
                                <div class="font-size-13 text-alt mb-1"><span
                                        class="fa fa-calendar text-muted mr-2"></span>
        ...
        <div class="col-md-12">
            <div class="timeline">
                <div class="outer radius-2 position-absolute">
                    <div class="ui-icon ui-icon-md inner">
                        <div class="ui-icon-inner">
                            <a href="javascript:;" style="font-size:20px;cursor: default;"><i
                                    class="fas fa-graduation-cap" style="cursor: default;"></i></a>
                        </div>
                    </div>
                </div>
                <div class="pt-7">
            ...
            @foreach ($about->certificates as $certificate)
                <div class="w-100 px-3 pt-5">
                    <div class="card bg-dark border-0">
                        <div class="card-body radius-2 pr-5 pl-5 pt-0 mb-3 shadow">
                            <div class="testimonial-image">
                                <div class="testimonial-image-border">
                                    <img class="img-fluid p-2" src="{{ asset('backend/img/icons/contract.png') }}"
