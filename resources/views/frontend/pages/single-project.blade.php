    ...
    <body>
        ...
        <div id="wrapper" class="wrapper">
            ...
            <section class="project spacer-xlg">
                ...
                <div class="row mb-5">
                    <div class="col">
                            <h6 class="font-weight-700  mb-0 text-uppercase mb-2">{{ $portfolio->category->name }}</h6>
                ...
                <div class="row align-items-center justify-content-center mt-6">
                    <div class="col-md-10">
                        ...
                        <img class="img-fluid" src="{{ asset('backend/img/portfolio/'.$portfolio->image) }}" alt="" style="width: 100%; height: 26rem;"><br><br>
                        ...
                        <ul class="list-inline font-size-15 w-100 float-left">
                            ...
                            <li>Year :
                                <strong class="font-weight-600 text-alt">{{ Carbon\Carbon::parse($portfolio->date)->format('M, Y') }}</strong>
                                </li>
                            @endif
                        </ul>
                    </div>
                ...
                <div class="row">
                            ...
                            <div class="outer radius-2 mr-3">
                                <div class="ui-icon ui-icon-md inner ">
                                    <div class="ui-icon-inner">
                                        <img src="{{ asset('backend/img/icons/open-in-browser.png') }}" style="width: 30px;"/>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 text-left  mb-2 mb-lg-0">
                        <a class="float-md-right" href="{{ route('home') }}#portfolio">
                            ...
                            <div class="media-body">
                                <span class="text-alt font-size-13 font-weight-600 text-uppercase">Back To Portfolio</span>
                            </div>
                            </div>
                        </a>
                    </div>
