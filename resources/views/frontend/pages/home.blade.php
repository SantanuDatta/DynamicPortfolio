...
@section('body-content')
    <div class="row">
        <div class="col-lg-9 my-order-switch-1">
            <section class="bg-dark radius-2 padding-dy text-center shadow" id="home">
                <div class="row v-height-50 v-centred">
                    <div class="col-md-12">
                        <h1 class="font-weight-600 mb-0">{{ $users->name }}</h1>
                        <div class="text-rotation">
                            <div class="item">
                                <h6 class="h5 text-alt mt-1 mb-0"> <span class="text-rotating">Wordpress
                                        Designer, Web
                                        Desinger, Web Developer, Laravel Developer</span></h6>
                            </div>
                        </div>
                        <ul class="list-inline mb-0 mt-4">
                            <li class="list-inline-item outer radius-2 mb-lg-0 mr-1 mb-2">
                            ...
                            <li class="list-inline-item outer radius-2 mb-lg-0 mx-0 mb-2">
                                <a class="inner btn btn-round btn-icon" href="#">
            ...
            <section class="bg-dark radius-2 padding-dy shadow" id="about">
                @include('frontend.pages.about')
            </section>
            <section class="bg-dark radius-2 padding-dy work shadow" id="portfolio">
                @include('frontend.pages.portfolio')
            </section>
            <section class="bg-dark radius-2 padding-dy shadow" id="contact">
