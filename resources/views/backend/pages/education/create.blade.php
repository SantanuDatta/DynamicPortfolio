            ...
            <div class="col-sm-12">
                <div class="card bd-0">
                    ...
                    <div class="card-body bd bd-t-0 rounded-bottom">
                        <form action="{{ route('education.store') }}" method="POST" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('studied_at') is-invalid @enderror"
                                            name="studied_at" type="text" value="{{ old('studied_at') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('info') is-invalid @enderror" id="short_desc" name="info">{{ old('short_desc') }}</textarea>
                                        @error('info')
                                            <span class="tx-danger"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('degree') is-invalid @enderror" id=""
                                            name="degree" type="text" value="{{ old('degree') }}"
