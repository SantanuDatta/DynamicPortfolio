            ...
            <div class="col-sm-12">
                <div class="card bd-0">
                    ...
                    <div class="card-body bd bd-t-0 rounded-bottom">
                        <form action="{{ route('experience.update', $experience) }}" method="POST" novalidate>
                            @csrf
                            @method('PATCH')
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('worked_at') is-invalid @enderror"
                                            name="worked_at" type="text" value="{{ $experience->worked_at }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('company_info') is-invalid @enderror" id="short_desc" name="company_info">{{ $experience->company_info }}</textarea>
                                        @error('company_info')
                                            <span class="tx-danger"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('worked_as') is-invalid @enderror" id=""
                                            name="worked_as" type="text" value="{{ $experience->worked_as }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input
                                                ...
                                                name="start_date" type="text" value="{{ $experience->start_date }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input
                                                ...
                                                name="end_date" type="text" value="{{ $experience->end_date }}"
                                                placeholder="MM/DD/YYYY">
                                        </div>
                                        @error('end_date')
                                            <span class="tx-danger"> {{ $message }} </span>
