    ...
    <div class="br-header-left">
        ...
        <nav class="nav">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
                <div class="tx-center">
                <a href=""><img src="{{ asset('backend/img/user/'. Auth::user()->image) }}" class="wd-80 rounded-circle" alt=""></a>
                <h6 class="logged-fullname">{{ Auth::user()->name }}</h6>
                <p>{{ Auth::user()->email }}</p>
                </div>
                <ul class="list-unstyled user-profile-nav">
                    <li><a href="{{ route('user.detail') }}"><i class="icon ion-ios-person"></i> Edit Profile</a></li>
